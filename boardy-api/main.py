...
async def redis_subscriber():
    ...
    # В Docker внутри сети Redis будет доступен по имени сервиса "redis"
    ...
    logger.info(
        "redis_subscriber: subscribed to "
        "laravel-database-new_post, "
        "laravel-database-update_post, "
        "laravel-database-delete_post, "
        "laravel-database-user.renamed"
...
# В Docker мы будем открывать фронт на http://localhost через Nginx
app.add_middleware(
    CORSMiddleware,
