...
$oauth_success = !empty($_SESSION['oauth_success']);
if ($oauth_success) unset($_SESSION['oauth_success']);
?>
<nav>
    ...
    <?php else: ?>
        ...
        <a href="/oauth-github.php"
           style="display:inline-flex;align-items:center;gap:6px;
                  background:#24292e;color:#fff;padding:6px 14px;
...
<div style="background:#d1fae5;color:#065f46;padding:10px 20px;text-align:center;font-size:14px;">
    ✅ Вы вошли через GitHub как <strong><?= htmlspecialchars($user_name) ?></strong>
</div>
<?php endif; ?>
